    ...
    return (
        <div className="space-y-8 animate-fade-in max-w-7xl mx-auto">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <h1 className="text-2xl font-black text-[#1E1B3A] tracking-tight">Subscription Management</h1>
                    <p className="text-sm font-medium text-[#8B85A5] mt-1">Assign and manage billing plans for your clinic staff.</p>
                </div>
            </div>

            {/* Platform Overview Cards */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="glass-card p-6 !bg-gradient-to-br !from-[#7C3AED] !to-[#4C1D95] border-0 text-white relative overflow-hidden shadow-xl">
                ...
                <div className="stat-card">
                    <div className="flex justify-between items-start">
                        <div>
                            <p className="text-xs font-black uppercase tracking-widest text-[#8B85A5] mb-1">Pro Users</p>
                            <h2 className="text-3xl font-black text-[#1E1B3A]">{serializedStaff.filter(s => s.plan === "Pro").length}</h2>
                        </div>
                ...
                <div className="stat-card">
                    <div className="flex justify-between items-start">
                        <div>
                            <p className="text-xs font-black uppercase tracking-widest text-[#8B85A5] mb-1">Standard Users</p>
                            <h2 className="text-3xl font-black text-[#1E1B3A]">{serializedStaff.filter(s => s.plan === "Standard" || s.plan === "Free").length}</h2>
                        </div>
                        <div className="icon-wrapper">
            ...
            <div className="glass-card overflow-hidden">
                <div className="p-6 border-b border-[#E9E5F5] flex items-center justify-between">
